...
Dafür müßte ein Rechner mit einer Tastatur und einem Typewriter, quasi einer Schreibmaschine, ausgestattet werden.
...
https://www-formal.stanford.edu/jmc/history/timesharing-memo/timesharing-memo.html
