...
summary = "Entdecken Sie die sieben Plagen der IT und lernen Sie, wie ein korrekter Umgang mit Zeichenketten Sie vor Irritationen bewahrt. Der Autor teilt seine Erkenntnisse über die Bedeutung von Unicode-Codepunkten und ihre Verwendung in Emoji."
